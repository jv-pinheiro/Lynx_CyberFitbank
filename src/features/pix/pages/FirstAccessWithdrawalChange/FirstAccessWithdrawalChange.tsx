...
import { useStyles } from './FirstAccessWithdrawalChange.styles'
...
const localStorageKey = 'firstAccessToWithdrawalChange'

export const FirstAccessWithdrawalChange: React.FC = () => {
