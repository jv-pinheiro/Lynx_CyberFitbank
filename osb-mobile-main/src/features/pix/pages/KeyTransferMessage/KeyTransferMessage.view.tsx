...
import { useStyles } from './KeyTransferMessage.style'
import { Loader } from 'components/Loader'

interface KeyTransferMessageViewProps {
...
export const KeyTransferMessageView: React.FC<KeyTransferMessageViewProps> = ({
  onDescriptionChange,
  onEditTagsClose,
