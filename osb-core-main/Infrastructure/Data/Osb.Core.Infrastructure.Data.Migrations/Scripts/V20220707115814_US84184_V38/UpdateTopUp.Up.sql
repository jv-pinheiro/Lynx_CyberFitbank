DROP FUNCTION public.updatetopup(bigint, bigint, character varying, character varying, integer, integer, bigint);
...
Update public."TopUp"
			  SET
                ...
                "BatchIdentifier" = "paramBatchIdentifier",
...
ALTER FUNCTION public.updatetopup(bigint, bigint, character varying, character varying, character varying, character varying, integer, integer, bigint)
    OWNER TO "OSB";
