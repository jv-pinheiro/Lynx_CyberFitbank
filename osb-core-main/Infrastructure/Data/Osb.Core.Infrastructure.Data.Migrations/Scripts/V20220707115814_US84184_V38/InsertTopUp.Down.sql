DROP FUNCTION public.inserttopup(bigint, bigint, integer, character varying, character varying, numeric, character varying, character varying, integer, bigint, integer, timestamp without time zone, boolean);
