...
CREATE OR REPLACE FUNCTION public.getbindcardbyidentifier(
    ...
    RETURNS TABLE("BindCardId" bigint, "AccountId" bigint, "CardOwnerId" bigint, "CardHolderId" bigint, "CardHolderContactId" bigint, "IdentifierCard" character varying, "UsageType" character varying, "Status" integer, "OperationId" bigint, "CreationDate" timestamp without time zone, "DeletionDate" timestamp without time zone, "UpdateDate" timestamp without time zone, "CreationUserId" bigint, "UpdateUserId" bigint) 
    LANGUAGE 'sql'
    COST 100
