DROP FUNCTION public.updateaccount(bigint, bigint, character varying, bigint, bigint, character varying, character varying, bigint);
...
ALTER FUNCTION public.updateaccount(bigint, bigint, character varying, bigint, bigint, bigint, character varying, character varying, bigint)
    OWNER TO "OSB";
